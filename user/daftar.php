    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../logodm.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 Selamat datang di sistem informasi Pendaftaran Santri Baru (PSB)  Online.
